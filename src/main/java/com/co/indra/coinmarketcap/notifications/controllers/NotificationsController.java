...
public class NotificationsController {
   ...
   @PostMapping("/{idUser}/usernotificationsdata")
   public void createDataToNotification(@RequestBody NotificationsDataRequest request,
         @PathVariable("idUser") Long idNotifications) {
      userNotificationsDataService.createDataUser(request.getIdUser(), request.getMail(), request.getPhoneNumber());
   }
