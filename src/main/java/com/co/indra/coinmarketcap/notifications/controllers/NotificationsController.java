...
public class NotificationsController {
	...
	@PostMapping(Routes.SEND_EMAIL_PATH)
	public void CreateEmail(@RequestBody Notifications notifications){
		notificationsService.createEmailNotification(notifications);
	}
